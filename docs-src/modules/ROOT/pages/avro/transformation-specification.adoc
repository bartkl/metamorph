...
NOTE: A property shape cannot be used as root by design. Although there's ways to make sense of this, it is unnecessarily complicated and provides nothing that a node shape does more explicitly.
